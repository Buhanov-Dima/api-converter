...
public partial class FileModels
{
    ...
    public virtual ReportIncomingTts? ReportIncomingTt { get; set; }

    public virtual ReportOutgoingTts? ReportOutgoingTt { get; set; }

    public virtual TypeDocuments? TypeDocument { get; set; }
}
